...
public class VideosController implements VideosControllerOpenApi {
    ...
    public ContractResponse<List<VideoDto>> listarVideos(@RequestParam(required = false) String descricao, HttpServletRequest request) {
    ...
    @GetMapping(value = "/{id}")
    @ResponseStatus(HttpStatus.OK)
    public ContractResponse<VideoDto> detalharVideo(@PathVariable(value = "id") Long id, HttpServletRequest request) {
    ...
    public ContractResponse<VideoDto> criarVideo(@RequestBody @Valid VideoInput videoInput, HttpServletRequest request) {
        return ContractResponse.<VideoDto>builder()
                .path(request.getServletPath())
    ...
    public void atualizarVideo(@PathVariable(value = "id") Long id, @RequestBody @Valid VideoInput videoInput, HttpServletRequest request) {
